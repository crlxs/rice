...
my_packages="curl ripgrep fd-find fzf unzip git zsh chromium compton feh xwallpaper fonts-noto-color-emoji nmap net-tools curl tcpdump xsel fuse3" #fuse3 is an nvim dependency
